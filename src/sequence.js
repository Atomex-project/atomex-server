...
MySequence = __decorate([
    __param(0, core_1.inject(SequenceActions.FIND_ROUTE)),
    __param(1, core_1.inject(SequenceActions.PARSE_PARAMS)),
    __param(2, core_1.inject(SequenceActions.INVOKE_METHOD)),
    __param(3, core_1.inject(SequenceActions.SEND)),
    __param(4, core_1.inject(SequenceActions.REJECT)),
    __param(5, core_1.inject(authentication_1.AuthenticationBindings.AUTH_ACTION)),
